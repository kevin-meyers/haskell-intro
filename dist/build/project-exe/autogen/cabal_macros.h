...
/* package arithmoi-0.10.0.0 */
#ifndef VERSION_arithmoi
#define VERSION_arithmoi "0.10.0.0"
...
/* package numerals-0.4.1 */
#ifndef VERSION_numerals
#define VERSION_numerals "0.4.1"
#endif /* VERSION_numerals */
#ifndef MIN_VERSION_numerals
#define MIN_VERSION_numerals(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  4 || \
  (major1) == 0 && (major2) == 4 && (minor) <= 1)
#endif /* MIN_VERSION_numerals */
...
#define CURRENT_COMPONENT_ID "project-0.1.0.0-JAnJ7mvXupgJQtRNxyg5gc-project-exe"
